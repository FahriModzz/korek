CATALOG :
{
    ...
    diablobotwhatsapp.reply(`SUKSES KIRIM, BERI JEDA BOT BIAR BOT GA KENON YA KONTOLL`)
    }

    STICKER : 
    {
        if (!isGroup) return diablobotwhatsapp.reply('Khusus Member Group FahriiModzxx')
        if (!q) return 
        num = `${q}`+'@s.whatsapp.net'
         jumlah = '2'
        waktu = '3s'
