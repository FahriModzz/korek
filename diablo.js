...
global.ownerNumber = ["085890283323@s.whatsapp.net"]
global.prefa = ['','.']
global.mess = {
...
╔══》 ғᴀʜʀɪɪ ᴍᴏᴅᴢxx
╠❏ ᴠᴇʀꜱɪᴏɴ : V3
╠❏ ᴄʀᴇᴀᴛᴏʀ : @6285890283323
╠❏ ʙᴏᴛ ɴᴀᴍᴇ : ғᴀʜʀɪɪ ʙᴏᴛ
╠❏ ᴏᴡɴᴇʀ ɴᴀᴍᴇ : ғᴀʜʀɪɪ ᴍᴏᴅᴢxx
╠❏ ʀᴜɴɴɪɴɢ : ᴘᴀɴᴇʟ ᴏɴʟʏ
╚═════════════════
╔══》𝕄𝔼ℕ𝕌 𝕆𝕎ℕ𝔼ℝ
╠❏ Sewa ( Cek Sewa ) 
...
╭━━•›〘 𝙄𝙉𝙁𝙊𝙎𝘾 〙
⎙ : *Script Update* : V3
⎙ : *Di Buat By* : FahriiModzxx
⎙ : *Nama sc* :  BUG VIP Fahrii
⎙ : *Total Fitur* : (99) fhl.dx17
⎙ : *Buy Sc*  : 6285890283323
╰───➤ 
`
...
⎙  Sewa Permanen 25K
⎙  Sc Bot? 40K
⎙  http://wa.me/6285890283323
╰───➤ 
`
diablobotwhatsapp.reply(Listjualan) 
break
case 'Listjualan':
textListjualan = `
╔══》
...
╚═════════════════
`
diablobotwhatsapp.reply (murbug) 
break
case 'murbug'
textmurbug = `
╔══》
⎙ Addakses : 5k
⎙ Addown : 10k
⎙ Patner murbug FahriiModzxx : 8k
╚═════════════════
`
diablobotwhatsapp.reply (sc) 
break
case 'sc'
textsc = `
╔══》
⎙ sc bug no enc 40k
⎙ sc bot biasa no enc 50k
⎙ jasa run bot 20k bisa nego
╚═════════════════
`
